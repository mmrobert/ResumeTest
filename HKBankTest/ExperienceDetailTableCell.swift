//
//  ExperienceDetailTableCell.swift
//  HKBankTest
//
...
class ExperienceDetailTableCell: UITableViewCell {
    ...
    var experienceI: ExperienceViewModel? {
        didSet {
            ...
            if let _duty = experienceI?.duties {
                let aStr = HelperFunctions.bulletPointStr(strings: _duty)
                dutyLabel.attributedText = aStr
            }
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        NSLayoutConstraint.activate([
            ...
            logoImg.widthAnchor.constraint(equalToConstant: 25),
            logoImg.heightAnchor.constraint(equalToConstant: 25)])
        ...
        NSLayoutConstraint.activate([
            dutyLabel.leadingAnchor.constraint(equalTo: self.contentView.leadingAnchor, constant: 25),
            dutyLabel.topAnchor.constraint(equalTo: timeLabel.bottomAnchor, constant: 5),
            dutyLabel.trailingAnchor.constraint(equalTo: self.contentView.trailingAnchor, constant: -8),
            dutyLabel.bottomAnchor.constraint(equalTo: self.contentView.bottomAnchor, constant: -7)])
    }
